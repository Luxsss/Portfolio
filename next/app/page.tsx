...
export default function Home() {
  ...
  return (
    <div>
      ...
      <svg ref={svgRefDesktop} className="ligne first-svg" width="2150" height="16839" viewBox="0 0 2150 16839" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ref={pathRefDesktop}
      ...
      <svg ref={svgRefMobile} className="ligne second-svg" width="2150" height="23856" viewBox="0 0 2150 23856" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ref={pathRefMobile}
