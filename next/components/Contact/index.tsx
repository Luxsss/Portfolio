...
export default function Contact() {
  ...
  // Références pour les SVG (flottants)
  const arrow1Ref = useRef(null)
  const arrow2Ref = useRef(null)
  const arrow3Ref = useRef(null)

  // Variables de l'animation flottante
  ...
  return (
    <div className={styles.contactPage} onMouseMove={handleMouseMove}>
      ...
      {/* Les SVG déjà présents restent à leur emplacement (les classes CSS définissent leur position absolue) */}
      <svg
        ref={arrow1Ref}
        width="315"
        height="247"
        ...
        className={styles.arrowContainer1}
      >
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className={styles.arrowContainer3}
      >
